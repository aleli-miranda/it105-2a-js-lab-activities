...
let ticket = {
 from: "Biringan Station",
 to: "Metropolitan City Station",
 price: 25.50
};

// --- ALL FIXES APPLIED HERE ---
// Access properties directly: ticket.from, ticket.to, ticket.price
console.log("From: " + ticket.from);
console.log("To: " + ticket.to);
console.log(`Price: ${ticket.price.toFixed(2)}$`); // Correctly accessing ticket.price
